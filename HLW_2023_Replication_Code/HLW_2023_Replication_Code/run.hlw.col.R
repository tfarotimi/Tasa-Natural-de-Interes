...
ca.data <- read.xlsx("inputData/Holston_Laubach_Williams_COL.xlsx", sheet="COL Input Data",
...
# Save output to CSV
write.table(output.ca, 'output/output.co.csv', col.names=TRUE, quote=FALSE, row.names=FALSE, sep = ',', na = '')
